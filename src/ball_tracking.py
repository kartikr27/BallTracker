        ...
        def main(self):
            try:
                ...
                while not rospy.is_shutdown():
                    ...
                    self.ballArea.add(getBallArea(getContours(mask,rospy.get_param("~minArea",150)),rospy.get_param("~e",0.5)))
                    rot_data = Float32()
                    ...
                    self.distance_pub.publish(getBallArea(getContours(mask,rospy.get_param("~minArea",150)),rospy.get_param("~e",0.5)))
